---
name: corpus-profile
description: "Builds a one-page signature profile from the corpus: who the person is, how they write (a drop-in voice block), what they're into, their key relationships, and trends over time. Use when the user wants a profile, signature, voice signature, summary of themselves, or asks what their data says about them. Fast and repeatable; coverage-aware — states what's thin and never invents what isn't there."
---

# corpus-profile

Stage 3 of the pipeline (acquire → collect → ingest → profile/analyze).
